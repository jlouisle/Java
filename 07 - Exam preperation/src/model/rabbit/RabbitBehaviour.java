...
public class RabbitBehaviour implements AnimalBehaviourStrategy {
	...
	public RabbitBehaviour(Area area) {
		super();
		this.area = area;
	}
	
	public void setAnimal(Animal animal) {
		this.rabbit = (Rabbit) animal;
	}
	...
	public void move() {
		...
		// closest
		Rabbit nearestPartner = (Rabbit) rabbit.getClosestDifferentSex();
		if (Math.random() < 0.1) {
