...
public class Fox extends Animal {
	...
	public Fox(Area area, CyclicBarrier synchronizationBarrier, Location startLocation) {
		super(area, synchronizationBarrier, startLocation, (Math.random()> 0.5 ? Animal.Gender.MALE :  Animal.Gender.FEMALE), Color.RED, new FoxBehaviour(area));
	}
